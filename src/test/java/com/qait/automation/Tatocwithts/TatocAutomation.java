...
public class TatocAutomation {
	...
	public void clickBasicCourse() {
        ...
        Assert.assertEquals(expectedUrl, this.driver.getCurrentUrl(), "navigation failed to greenbox page ");
	}
	...
	public void greenBox() {
        ...
        Assert.assertEquals(expectedUrl, driver.getCurrentUrl(), "navigation failed to frame dungeon page");
	}
	...
	public void frameDungeon() {
        ...
        Assert.assertEquals(expectedUrl, driver.getCurrentUrl(), "navigation failed to drag and drop page");
	}
	...
	public void dragAndDrop() {
        ...
        Assert.assertEquals(expectedUrl, driver.getCurrentUrl(), "navigation failed to popup windows page");
	}
	...
	public void popupWindows() {
        ...
        Assert.assertEquals(expectedUrl, driver.getCurrentUrl(), "navigation failed to token generation page");
	}
	...
	public void tokenGeneration() {
        ...
        Assert.assertEquals(expectedUrl, driver.getCurrentUrl(), "navigation failed to end page");
	}
